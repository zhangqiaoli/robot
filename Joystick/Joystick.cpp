...
//	client->m_tcpRobotAgent.m_sMonitorAddress = "172.16.4.99";
//	client->m_tcpRobotAgent.m_nMonitorPort = 18020;
...
//// "IG_" (ex. "VID_045E&PID_028E&IG_00").  If it does, then it抯 an XInput device
...
//		return S_OK;
//	
//	//CPicaSoftEvent hHandleEvent;
//	//HANDLE hHandleEvent = CreateEvent(NULL, FALSE, FALSE, NULL);
//	hr = g_pJoystick->SetEventNotification(g_Event);
//	hr = g_pJoystick->Acquire();
//	//int a = hHandleEvent.Lock(1000);
//	while (TRUE)
//	{
//		DWORD a = WaitForSingleObject(g_Event, 1000);
//		if (a == WAIT_OBJECT_0)
//		{
//			hr = g_pJoystick->Acquire();
...
//			// zql add
//			JoystickClient* client = JoystickClient::instance();
//			client->m_tcpRobotAgent.SendMessage_Active("spin", 1);
//			//client->m_tcpRobotAgent
//			// zql add end
...
//    hr = g_pJoystick->Poll();
//	//HANDLE hHandleEvent = CreateEvent(NULL, FALSE, FALSE, NULL);
//	//hr = g_pJoystick->SetEventNotification(hHandleEvent);
//    if( FAILED( hr ) )
//    {
